...
import com.atguigu.scw.user.resp.vo.UserAddressAddVo;
import com.atguigu.scw.user.resp.vo.UserAddressDeleteVo;
import com.atguigu.scw.user.resp.vo.UserAddressUpdateVo;
import com.atguigu.scw.user.resp.vo.UserAddressVo;
import com.atguigu.scw.user.resp.vo.UserDetailVo;
import com.atguigu.scw.user.resp.vo.UserProjectVo;
import com.atguigu.scw.user.resp.vo.UserUpdateVo;
...
public class MemberController {
	...
	public AppResponse<List<UserAddressVo>> address(String accessToken){
		...
		if(StringUtils.isEmpty(memberId)) {
			...
			appResponse.setMsg("accessToken失效");
			return appResponse;
		}
		
		List<UserAddressVo> list = memberService.ListAllAddressByAccessToken(memberId);
