...
public interface TAdminRoleMapper {
	...
	void saveAdminAndRoleRelationship(@Param("roleIds")Integer[] id, @Param("adminId")Integer adminId);

	void deleteAdminAndRoleRelationship(@Param("roleIds")String roleIds, @Param("adminId")Integer adminId);
