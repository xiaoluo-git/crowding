...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="doLogin" class="form-signin" role="form" method="post">
        <h2 class="form-signin-heading"><i class="glyphicon glyphicon-log-in"></i> 用户登录</h2>
		  ...
		  <div class="form-group has-success has-feedback">
			<select class="form-control" name="logintype">
                <option value="member" ${param.logintype} == "member" ? selected : "">会员</option>
                <option value="user" ${param.logintype} == "user" ? selected : "">管理</option>
            </select>
		  </div>
        <div class="checkbox">
          <label>
    ...
    <script type="text/javascript">
    	function dologin(){
    		...
    		if(loginType == "member"){
    			...
    			if(loginacct == ""){
    				layer.msg('用户名不能为空！',{icon:5,time:2000,anim:6,skin: 'layui-layer-molv',});
    				return false;
    			}
    			var userpswd = $("#userpswd").val();
    			if(userpswd == ""){
    				layer.msg('密码不能为空！',{icon:5,time:2000,anim:6});
    				return false;
    			}
